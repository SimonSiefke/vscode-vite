...
export async function resolveOptions(mode: string) {
  // specify env mode
  argv.mode = mode
...
export async function runServe(options: UserConfig) {
...
export async function runBuild(options: UserConfig) {
  try {
...
export async function runOptimize(options: UserConfig) {
  try {
